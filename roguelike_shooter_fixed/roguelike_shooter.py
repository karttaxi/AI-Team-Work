...
def draw_ui(surface, player, wave, kills, next_wave_kills):
    ...
    panel_x = WIDTH - 300
    panel_y = 18
    pygame.draw.rect(surface, (25, 25, 32), (panel_x - 10, panel_y - 8, 288, 160), border_radius=8)
    pygame.draw.rect(surface, GRAY, (panel_x - 10, panel_y - 8, 288, 160), 2, border_radius=8)
    draw_text(surface, "무기 상태", FONT, WHITE, panel_x, panel_y)

    y = panel_y + 32
    for weapon in player.weapons[:5]:
        if weapon.kind == "ranged":
